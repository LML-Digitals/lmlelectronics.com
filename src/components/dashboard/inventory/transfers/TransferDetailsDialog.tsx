                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="space-y-1 flex-1">
                    ...
                    <div className="bg-primary-50 p-3 flex justify-between rounded-md border">
                      ...
                      <Badge variant="outline" className="mt-2">
                        {transfer.inventoryVariation?.stockLevels?.find((level) => level.locationId === transfer.fromLocationId)?.stock || 0}
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1 flex-1">
                    ...
                    <div className="bg-primary-50 p-3 flex justify-between rounded-md border">
                      ...
                      <Badge variant="outline" className="mt-2">
                        {transfer.inventoryVariation?.stockLevels?.find((level) => level.locationId === transfer.toLocationId)?.stock || 0}
                      </Badge>
                    </div>
                  </div>
                </div>
